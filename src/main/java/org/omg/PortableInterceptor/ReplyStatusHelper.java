...
abstract public class ReplyStatusHelper
{
  private static String  _id = "IDL:omg.org/PortableInterceptor/ReplyStatus:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (org.omg.PortableInterceptor.ReplyStatusHelper.id (), "ReplyStatus", __typeCode);
    }
    return __typeCode;
  }
