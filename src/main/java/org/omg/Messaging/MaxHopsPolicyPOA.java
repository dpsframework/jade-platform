...
/**
* org/omg/Messaging/MaxHopsPolicyPOA.java .
...
public abstract class MaxHopsPolicyPOA extends org.omg.PortableServer.Servant
 implements org.omg.Messaging.MaxHopsPolicyOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("_get_max_hops", new java.lang.Integer (0));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // Messaging/MaxHopsPolicy/_get_max_hops
       {
         short $result = (short)0;
         $result = this.max_hops ();
         out = $rh.createReply();
  ...
  public MaxHopsPolicy _this() 
  {
    return MaxHopsPolicyHelper.narrow(
    super._this_object());
  }

  public MaxHopsPolicy _this(org.omg.CORBA.ORB orb) 
  {
    return MaxHopsPolicyHelper.narrow(
