...
public class _SyncScopePolicyStub extends org.omg.CORBA.portable.ObjectImpl implements org.omg.Messaging.SyncScopePolicy
{
  ...
  public short synchronization ()
  {
            ...
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_get_synchronization", true);
                $in = _invoke ($out);
                short $result = org.omg.Messaging.SyncScopeHelper.read ($in);
                return $result;
