...
public abstract class RoutingPolicyPOA extends org.omg.PortableServer.Servant
 implements org.omg.Messaging.RoutingPolicyOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("_get_routing_range", new java.lang.Integer (0));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // Messaging/RoutingPolicy/_get_routing_range
       {
         org.omg.Messaging.RoutingTypeRange $result = null;
         $result = this.routing_range ();
         out = $rh.createReply();
         org.omg.Messaging.RoutingTypeRangeHelper.write (out, $result);
         break;
       }
  ...
  public RoutingPolicy _this() 
  {
    return RoutingPolicyHelper.narrow(
    super._this_object());
  }

  public RoutingPolicy _this(org.omg.CORBA.ORB orb) 
  {
    return RoutingPolicyHelper.narrow(
