...
public class _RebindPolicyStub extends org.omg.CORBA.portable.ObjectImpl implements org.omg.Messaging.RebindPolicy
{
  ...
  public short rebind_mode ()
  {
            ...
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_get_rebind_mode", true);
                $in = _invoke ($out);
                short $result = org.omg.Messaging.RebindModeHelper.read ($in);
                return $result;
