...
public abstract class RebindPolicyPOA extends org.omg.PortableServer.Servant
 implements org.omg.Messaging.RebindPolicyOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("_get_rebind_mode", new java.lang.Integer (0));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // Messaging/RebindPolicy/_get_rebind_mode
       {
         short $result = (short)0;
         $result = this.rebind_mode ();
         out = $rh.createReply();
  ...
  {
    return RebindPolicyHelper.narrow(
    super._this_object());
  }

  public RebindPolicy _this(org.omg.CORBA.ORB orb) 
  {
    return RebindPolicyHelper.narrow(
