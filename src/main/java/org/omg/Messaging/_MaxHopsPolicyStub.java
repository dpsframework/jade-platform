...
public class _MaxHopsPolicyStub extends org.omg.CORBA.portable.ObjectImpl implements org.omg.Messaging.MaxHopsPolicy
{
  ...
  public short max_hops ()
  {
            ...
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_get_max_hops", true);
                $in = _invoke ($out);
