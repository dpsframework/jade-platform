...
public abstract class RequestPriorityPolicyPOA extends org.omg.PortableServer.Servant
 implements org.omg.Messaging.RequestPriorityPolicyOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("_get_priority_range", new java.lang.Integer (0));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // Messaging/RequestPriorityPolicy/_get_priority_range
       {
         org.omg.Messaging.PriorityRange $result = null;
         $result = this.priority_range ();
         out = $rh.createReply();
         org.omg.Messaging.PriorityRangeHelper.write (out, $result);
         break;
       }
  ...
  public RequestPriorityPolicy _this() 
  {
    return RequestPriorityPolicyHelper.narrow(
    super._this_object());
  }

  public RequestPriorityPolicy _this(org.omg.CORBA.ORB orb) 
  {
    return RequestPriorityPolicyHelper.narrow(
...
} // class RequestPriorityPolicyPOA
