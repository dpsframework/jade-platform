...
public class _QueueOrderPolicyStub extends org.omg.CORBA.portable.ObjectImpl implements org.omg.Messaging.QueueOrderPolicy
{
  ...
  public short allowed_orders ()
  {
            ...
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_get_allowed_orders", true);
                $in = _invoke ($out);
                short $result = org.omg.Messaging.OrderingHelper.read ($in);
                return $result;
