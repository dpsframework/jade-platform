...
public abstract class SyncScopePolicyPOA extends org.omg.PortableServer.Servant
 implements org.omg.Messaging.SyncScopePolicyOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("_get_synchronization", new java.lang.Integer (0));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // Messaging/SyncScopePolicy/_get_synchronization
       {
  ...
  {
    return SyncScopePolicyHelper.narrow(
    super._this_object());
  }

  public SyncScopePolicy _this(org.omg.CORBA.ORB orb) 
  {
    return SyncScopePolicyHelper.narrow(
