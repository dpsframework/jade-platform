...
public abstract class ReplyEndTimePolicyPOA extends org.omg.PortableServer.Servant
 implements org.omg.Messaging.ReplyEndTimePolicyOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("_get_end_time", new java.lang.Integer (0));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // Messaging/ReplyEndTimePolicy/_get_end_time
       {
  ...
  public ReplyEndTimePolicy _this() 
  {
    return ReplyEndTimePolicyHelper.narrow(
    super._this_object());
  }

  public ReplyEndTimePolicy _this(org.omg.CORBA.ORB orb) 
  {
    return ReplyEndTimePolicyHelper.narrow(
