...
/**
* org/omg/Messaging/QueueOrderPolicyPOA.java .
...
public abstract class QueueOrderPolicyPOA extends org.omg.PortableServer.Servant
 implements org.omg.Messaging.QueueOrderPolicyOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("_get_allowed_orders", new java.lang.Integer (0));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // Messaging/QueueOrderPolicy/_get_allowed_orders
       {
         short $result = (short)0;
         $result = this.allowed_orders ();
         out = $rh.createReply();
  ...
  public QueueOrderPolicy _this() 
  {
    return QueueOrderPolicyHelper.narrow(
    super._this_object());
  }

  public QueueOrderPolicy _this(org.omg.CORBA.ORB orb) 
  {
    return QueueOrderPolicyHelper.narrow(
