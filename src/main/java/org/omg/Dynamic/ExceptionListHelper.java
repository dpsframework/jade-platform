...
{
  private static String  _id = "IDL:omg.org/Dynamic/ExceptionList:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (org.omg.Dynamic.ExceptionListHelper.id (), "ExceptionList", __typeCode);
    }
    return __typeCode;
  }
  ...
  {
    org.omg.CORBA.TypeCode value[] = null;
    int _len0 = istream.read_long ();
    value = new org.omg.CORBA.TypeCode[_len0];
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = istream.read_TypeCode ();
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, org.omg.CORBA.TypeCode[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      ostream.write_TypeCode (value[_i0]);
  }
