...
public class _UnionDefStub extends org.omg.CORBA.portable.ObjectImpl implements org.omg.CORBA.UnionDef
{
  ...
  public org.omg.CORBA.TypeCode discriminator_type ()
  {
            ...
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_get_discriminator_type", true);
                $in = _invoke ($out);
  ...
  public org.omg.CORBA.IDLType discriminator_type_def ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_get_discriminator_type_def", true);
                $in = _invoke ($out);
  ...
  public void discriminator_type_def (org.omg.CORBA.IDLType newDiscriminator_type_def)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_set_discriminator_type_def", true);
                org.omg.CORBA.IDLTypeHelper.write ($out, newDiscriminator_type_def);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                discriminator_type_def (newDiscriminator_type_def        );
            } finally {
                _releaseReply ($in);
            }
  } // discriminator_type_def
  ...
  public org.omg.CORBA.UnionMember[] members ()
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                org.omg.CORBA.UnionMember $result[] = org.omg.CORBA.UnionMemberSeqHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  public void members (org.omg.CORBA.UnionMember[] newMembers)
  {
            ...
            try {
                ...
                org.omg.CORBA.UnionMemberSeqHelper.write ($out, newMembers);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
