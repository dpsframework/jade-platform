...
/**
* org/omg/CORBA/UnionMemberSeqHelper.java .
...
{
  private static String  _id = "IDL:omg.org/CORBA/UnionMemberSeq:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = org.omg.CORBA.UnionMemberHelper.type ();
      __typeCode = org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (org.omg.CORBA.UnionMemberSeqHelper.id (), "UnionMemberSeq", __typeCode);
    }
    return __typeCode;
  }
  ...
  {
    org.omg.CORBA.UnionMember value[] = null;
    int _len0 = istream.read_long ();
    value = new org.omg.CORBA.UnionMember[_len0];
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = org.omg.CORBA.UnionMemberHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, org.omg.CORBA.UnionMember[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      org.omg.CORBA.UnionMemberHelper.write (ostream, value[_i0]);
  }
