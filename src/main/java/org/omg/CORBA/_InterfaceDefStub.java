...
public class _InterfaceDefStub extends org.omg.CORBA.portable.ObjectImpl implements org.omg.CORBA.InterfaceDef
{
  ...
  public org.omg.CORBA.InterfaceDef[] base_interfaces ()
  {
            ...
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_get_base_interfaces", true);
                $in = _invoke ($out);
  ...
  // read/write interface
  public void base_interfaces (org.omg.CORBA.InterfaceDef[] newBase_interfaces)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_set_base_interfaces", true);
                org.omg.CORBA.InterfaceDefSeqHelper.write ($out, newBase_interfaces);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
  ...
  public boolean is_a (String interface_id)
  {
            ...
            try {
                ...
                org.omg.CORBA.RepositoryIdHelper.write ($out, interface_id);
                $in = _invoke ($out);
                boolean $result = $in.read_boolean ();
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
  ...
  public org.omg.CORBA.InterfaceDefPackage.FullInterfaceDescription describe_interface ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("describe_interface", true);
                $in = _invoke ($out);
                org.omg.CORBA.InterfaceDefPackage.FullInterfaceDescription $result = org.omg.CORBA.InterfaceDefPackage.FullInterfaceDescriptionHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
