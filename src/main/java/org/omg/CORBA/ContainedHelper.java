...
abstract public class ContainedHelper
{
  private static String  _id = "IDL:omg.org/CORBA/Contained:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = org.omg.CORBA.ORB.init ().create_interface_tc (org.omg.CORBA.ContainedHelper.id (), "Contained");
    }
    return __typeCode;
  }
  ...
  {
    return narrow (istream.read_Object (_ContainedStub.class));
  }
  ...
  public static org.omg.CORBA.Contained narrow (org.omg.CORBA.Object obj)
  {
    if (obj == null)
      return null;
    ...
    else
    {
      ...
      org.omg.CORBA._ContainedStub stub = new org.omg.CORBA._ContainedStub ();
      stub._set_delegate(delegate);
      return stub;
    }
  }

  public static org.omg.CORBA.Contained unchecked_narrow (org.omg.CORBA.Object obj)
  {
    if (obj == null)
      return null;
    else if (obj instanceof org.omg.CORBA.Contained)
