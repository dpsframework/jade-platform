...
public abstract class UnionDefPOA extends org.omg.PortableServer.Servant
 implements org.omg.CORBA.UnionDefOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("_get_discriminator_type", new java.lang.Integer (0));
    _methods.put ("_get_discriminator_type_def", new java.lang.Integer (1));
    _methods.put ("_set_discriminator_type_def", new java.lang.Integer (2));
    _methods.put ("_get_members", new java.lang.Integer (3));
    _methods.put ("_set_members", new java.lang.Integer (4));
    ...
    _methods.put ("_get_type", new java.lang.Integer (18));
    _methods.put ("lookup", new java.lang.Integer (19));
    _methods.put ("contents", new java.lang.Integer (20));
    _methods.put ("lookup_name", new java.lang.Integer (21));
    _methods.put ("describe_contents", new java.lang.Integer (22));
    _methods.put ("create_module", new java.lang.Integer (23));
    _methods.put ("create_constant", new java.lang.Integer (24));
    _methods.put ("create_struct", new java.lang.Integer (25));
    _methods.put ("create_union", new java.lang.Integer (26));
    _methods.put ("create_enum", new java.lang.Integer (27));
    _methods.put ("create_alias", new java.lang.Integer (28));
    _methods.put ("create_exception", new java.lang.Integer (29));
    _methods.put ("create_interface", new java.lang.Integer (30));
    _methods.put ("create_value", new java.lang.Integer (31));
    _methods.put ("create_value_box", new java.lang.Integer (32));
    _methods.put ("create_native", new java.lang.Integer (33));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // org/omg/CORBA/UnionDef/_get_discriminator_type
       {
         org.omg.CORBA.TypeCode $result = null;
         $result = this.discriminator_type ();
         out = $rh.createReply();
         out.write_TypeCode ($result);
         break;
       }

       case 1:  // org/omg/CORBA/UnionDef/_get_discriminator_type_def
       {
         org.omg.CORBA.IDLType $result = null;
         $result = this.discriminator_type_def ();
         out = $rh.createReply();
         org.omg.CORBA.IDLTypeHelper.write (out, $result);
         break;
       }

       case 2:  // org/omg/CORBA/UnionDef/_set_discriminator_type_def
       {
         org.omg.CORBA.IDLType newDiscriminator_type_def = org.omg.CORBA.IDLTypeHelper.read (in);
         this.discriminator_type_def (newDiscriminator_type_def);
         out = $rh.createReply();
         break;
       }

       case 3:  // org/omg/CORBA/UnionDef/_get_members
       {
         org.omg.CORBA.UnionMember $result[] = null;
         $result = this.members ();
         out = $rh.createReply();
         org.omg.CORBA.UnionMemberSeqHelper.write (out, $result);
         break;
       }

       case 4:  // org/omg/CORBA/UnionDef/_set_members
       {
         org.omg.CORBA.UnionMember newMembers[] = org.omg.CORBA.UnionMemberSeqHelper.read (in);
  ...
  // write interface
       ...
       case 18:  // org/omg/CORBA/IDLType/_get_type
       {
         org.omg.CORBA.TypeCode $result = null;
         $result = this.type ();
         out = $rh.createReply();
  ...
  // read interface
       case 19:  // org/omg/CORBA/Container/lookup
       {
       ...
       case 20:  // org/omg/CORBA/Container/contents
       {
       ...
       case 21:  // org/omg/CORBA/Container/lookup_name
       {
       ...
       case 22:  // org/omg/CORBA/Container/describe_contents
       {
         org.omg.CORBA.DefinitionKind limit_type = org.omg.CORBA.DefinitionKindHelper.read (in);
         boolean exclude_inherited = in.read_boolean ();
  ...
  // write interface
       case 23:  // org/omg/CORBA/Container/create_module
       {
       ...
       case 24:  // org/omg/CORBA/Container/create_constant
       {
         String id = org.omg.CORBA.RepositoryIdHelper.read (in);
         String name = org.omg.CORBA.IdentifierHelper.read (in);
         String version = org.omg.CORBA.VersionSpecHelper.read (in);
       ...
       case 25:  // org/omg/CORBA/Container/create_struct
       {
         String id = org.omg.CORBA.RepositoryIdHelper.read (in);
         String name = org.omg.CORBA.IdentifierHelper.read (in);
         String version = org.omg.CORBA.VersionSpecHelper.read (in);
       ...
       case 26:  // org/omg/CORBA/Container/create_union
       {
         String id = org.omg.CORBA.RepositoryIdHelper.read (in);
         String name = org.omg.CORBA.IdentifierHelper.read (in);
         String version = org.omg.CORBA.VersionSpecHelper.read (in);
       ...
       case 27:  // org/omg/CORBA/Container/create_enum
       {
         String id = org.omg.CORBA.RepositoryIdHelper.read (in);
         String name = org.omg.CORBA.IdentifierHelper.read (in);
         String version = org.omg.CORBA.VersionSpecHelper.read (in);
       ...
       case 28:  // org/omg/CORBA/Container/create_alias
       {
         String id = org.omg.CORBA.RepositoryIdHelper.read (in);
         String name = org.omg.CORBA.IdentifierHelper.read (in);
         String version = org.omg.CORBA.VersionSpecHelper.read (in);
       ...
       case 29:  // org/omg/CORBA/Container/create_exception
       {
         String id = org.omg.CORBA.RepositoryIdHelper.read (in);
         String name = org.omg.CORBA.IdentifierHelper.read (in);
         String version = org.omg.CORBA.VersionSpecHelper.read (in);
       ...
       case 30:  // org/omg/CORBA/Container/create_interface
       {
         String id = org.omg.CORBA.RepositoryIdHelper.read (in);
         String name = org.omg.CORBA.IdentifierHelper.read (in);
         String version = org.omg.CORBA.VersionSpecHelper.read (in);
  ...
  // orbos 98-01-18: Objects By Value
       case 31:  // org/omg/CORBA/Container/create_value
       {
         String id = org.omg.CORBA.RepositoryIdHelper.read (in);
         String name = org.omg.CORBA.IdentifierHelper.read (in);
         String version = org.omg.CORBA.VersionSpecHelper.read (in);
  ...
  // orbos 98-01-18: Objects By Value
       case 32:  // org/omg/CORBA/Container/create_value_box
       {
         String id = org.omg.CORBA.RepositoryIdHelper.read (in);
         String name = org.omg.CORBA.IdentifierHelper.read (in);
         String version = org.omg.CORBA.VersionSpecHelper.read (in);
       ...
       case 33:  // org/omg/CORBA/Container/create_native
       {
         String id = org.omg.CORBA.RepositoryIdHelper.read (in);
         String name = org.omg.CORBA.IdentifierHelper.read (in);
         String version = org.omg.CORBA.VersionSpecHelper.read (in);
  ...
  public UnionDef _this() 
  {
    return UnionDefHelper.narrow(
    super._this_object());
  }

  public UnionDef _this(org.omg.CORBA.ORB orb) 
  {
    return UnionDefHelper.narrow(
