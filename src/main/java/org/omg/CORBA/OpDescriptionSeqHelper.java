...
/**
* org/omg/CORBA/OpDescriptionSeqHelper.java .
...
abstract public class OpDescriptionSeqHelper
{
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = org.omg.CORBA.OperationDescriptionHelper.type ();
      __typeCode = org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (org.omg.CORBA.OpDescriptionSeqHelper.id (), "OpDescriptionSeq", __typeCode);
    }
    return __typeCode;
  }
  ...
  {
    org.omg.CORBA.OperationDescription value[] = null;
    int _len0 = istream.read_long ();
    value = new org.omg.CORBA.OperationDescription[_len0];
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = org.omg.CORBA.OperationDescriptionHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, org.omg.CORBA.OperationDescription[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      org.omg.CORBA.OperationDescriptionHelper.write (ostream, value[_i0]);
  }
