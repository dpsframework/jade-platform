 ...
 implements org.omg.DynamicAny.DynValueBoxOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  /**
          ...
          * </UL>
          */
       case 55:  // DynamicAny/DynAny/component_count
       {
         int $result = (int)0;
  ...
  /**
          ...
          */
       case 56:  // DynamicAny/DynAny/current_component
       {
         try {
           org.omg.DynamicAny.DynAny $result = null;
  ...
  {
    return DynValueBoxHelper.narrow(
    super._this_object());
  }

  public DynValueBox _this(org.omg.CORBA.ORB orb) 
  {
    return DynValueBoxHelper.narrow(
